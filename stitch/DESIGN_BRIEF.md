...
- RelaySwitch Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called RelaySwitch Lite. It should be a full-viewport switching arcade game where the player routes moving energy packets across a live relay grid, flips junctions with keyboard or click controls, collects charge boosts, avoids overload cells, and can open a settings overlay with…
...
- Gameplay - RelaySwitch Lite
- Game Settings - RelaySwitch Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - RelaySwitch Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - RelaySwitch Lite
